...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, ru.vlsu.animalcertification.domain.Animal.class.getName() + ".requests");
            ...
            createCache(cm, ru.vlsu.animalcertification.domain.Request.class.getName() + ".animals");
