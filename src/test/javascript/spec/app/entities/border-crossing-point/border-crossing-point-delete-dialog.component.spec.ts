...
describe('Component Tests', () => {
  describe('BorderCrossingPoint Management Delete Component', () => {
    let comp: BorderCrossingPointDeleteDialogComponent;
    let fixture: ComponentFixture<BorderCrossingPointDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(BorderCrossingPointDeleteDialogComponent);
