  ...
  describe('PersonalData Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PersonDataDeleteDialogComponent],
      })
        .overrideTemplate(PersonDataDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(PersonDataDeleteDialogComponent);
