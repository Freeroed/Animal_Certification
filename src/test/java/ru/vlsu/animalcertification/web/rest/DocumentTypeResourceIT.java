...
public class DocumentTypeResourceIT {
    ...
    public void createDocumentType() throws Exception {
        ...
        assertThat(testDocumentType.getNameEng()).isEqualTo(DEFAULT_NAME_ENG);
    }
    ...
    public void updateDocumentType() throws Exception {
        ...
        assertThat(testDocumentType.getNameEng()).isEqualTo(UPDATED_NAME_ENG);
    }
